    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Todo` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `task` TEXT NOT NULL, `time` TEXT NOT NULL, `scheduleTime` TEXT NOT NULL)');
...
class _$TodoDao extends TodoDao {
  ...
  Future<List<Todo?>> findAllTodo() async {
    return _queryAdapter.queryList('SELECT * FROM todo',
        mapper: (Map<String, Object?> row) => Todo(row['task'] as String,
            row['time'] as String, row['scheduleTime'] as String));
  }
